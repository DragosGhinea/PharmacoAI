    ...
    <div className="text-on-surface selection:bg-secondary-container selection:text-on-secondary-container">
      <nav className="bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-md shadow-sm dark:shadow-none docked full-width top-0 sticky z-50">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="text-2xl font-bold font-serif text-slate-900 dark:text-slate-50">PharmacoAI</div>
          <div className="hidden md:flex gap-8 items-center">
            <a
              className="text-teal-700 dark:text-teal-400 border-b-2 border-teal-700 dark:border-teal-400 pb-1 manrope text-sm font-semibold"
              href="#"
            >
              Solutions
            </a>
            <a
              className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors manrope text-sm font-semibold"
              href="#"
            >
              How it Works
            </a>
          ...
          <button className="bg-primary-container text-white px-6 py-2.5 rounded-lg font-semibold manrope text-sm hover:scale-95 transition-transform duration-150 active:scale-90" type="button">
            Request Demo
          </button>
        </div>
      </nav>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 z-10">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button className="px-8 py-4 bg-surface-container-low text-primary rounded-2xl font-bold text-lg hover:bg-surface-container-high transition-colors" type="button">
                  Explore Solutions
                </button>
              </div>
            </div>
      ...
      <footer className="bg-slate-100 dark:bg-slate-900 border-t-0">
        ...
        <div className="max-w-7xl mx-auto px-8 py-8 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="manrope text-xs tracking-wide text-slate-500 dark:text-slate-400">
            © 2026 PharmacoAI. All clinical insights powered by proprietary machine learning.
          </p>
